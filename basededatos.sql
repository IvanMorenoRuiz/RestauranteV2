...
CREATE TABLE `tbl_mesas` (
  ...
  `estado_mesa` ENUM ("Libre","Ocupada","Reservada") NOT NULL,
  `sillas_mesa` ENUM ("2","3","4","5","6","7","8","12") NOT NULL,
...
VALUES
  ...
  ('ianromero', 'Ian', 'Romero', '$2y$10$wigWyJ26umFhiMWROr/DK.NqNltLAI4M2dRT5l4MyPPkoy4YN5rW6', './img/ian.jpg');
...
-- Inserta aquí los datos de las reservas si es necesario
